...
| Require blank lines around headings                     | **[MD022]** _blanks-around-headings_<br>Headings should be surrounded by blank lines                    | --                                                                                                     | --                                                                                                                                                   |
...
| Require blank lines around lists    | **[MD032]** _blanks-around-lists_<br>Lists should be surrounded by blank lines         | --                        | --                                                                                                              |
...
| Disallow missing reference for link fragments | **[MD051]** _link-fragments_<br>Link fragments should be valid                                          | --                                                                        | --                                                                                                                                       |
...
| Description                               | [markdownlint]'s Rule                                                                        | [@eslint/markdown]'s Rule                                                       | `eslint-plugin-markdown-preferences`'s Rule                                                                             |
| ----------------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Blank lines around fenced code blocks     | **[MD031]** _blanks-around-fences_<br>Fenced code blocks should be surrounded by blank lines | --                                                                              | --                                                                                                                      |
...
- **[MD009]** _no-trailing-spaces_<br>Trailing spaces
- **[MD010]** _no-hard-tabs_<br>Hard tabs
...
- **[MD038]** _no-space-in-code_<br>Spaces inside code span elements
- **[MD044]** _proper-names_<br>Proper names should have the correct capitalization
- **[MD047]** _single-trailing-newline_<br>Files should end with a single newline character
- **[MD049]** _emphasis-style_<br>Emphasis style
- **[MD050]** _strong-style_<br>Strong style
- **[MD055]** _table-pipe-style_<br>Table pipe style
- **[MD056]** _table-column-count_<br>Table column count
- **[MD058]** _blanks-around-tables_<br>Tables should be surrounded by blank lines
- **[MD059]** _descriptive-link-text_<br>Link text should be descriptive

### `@eslint/markdown` Rules

- [markdown/no-duplicate-definitions]<br>Disallow duplicate definitions
- [markdown/no-empty-definitions]<br>Disallow empty definitions
- [markdown/no-html]<br>Disallow HTML tags
- [markdown/no-missing-link-fragments]<br>Disallow link fragments that do not reference valid headings
- [markdown/table-column-count]<br>Disallow data rows in a GitHub Flavored Markdown table from having more cells than the header row

### `eslint-plugin-markdown-preferences` Rules

- **[markdown-preferences/emoji-notation]**<br>enforce consistent emoji notation style in Markdown files
