...
| [markdown-preferences/thematic-break-character-style](./thematic-break-character-style.md) | enforce a consistent character style for thematic breaks (horizontal rules) in Markdown. | 🔧 |  |
