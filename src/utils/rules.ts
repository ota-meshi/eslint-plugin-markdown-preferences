...
import linkDestinationStyle from "../rules/link-destination-style.ts";
import linkParenNewline from "../rules/link-paren-newline.ts";
...
import tablePipeSpacing from "../rules/table-pipe-spacing.ts";
